...
const cssPropsManager = new CssPropsManager(() => {
    ...
    return {
        fontSize1         : [['calc(', 2.25, '*', (gens.fontSize as string), ')']] as Prop.FontSize | Cust.Expr,
        fontSize2         : [['calc(', 2.00, '*', (gens.fontSize as string), ')']] as Prop.FontSize | Cust.Expr,
        fontSize3         : [['calc(', 1.75, '*', (gens.fontSize as string), ')']] as Prop.FontSize | Cust.Expr,
        fontSize4         : [['calc(', 1.50, '*', (gens.fontSize as string), ')']] as Prop.FontSize | Cust.Expr,
        fontSize5         : [['calc(', 1.25, '*', (gens.fontSize as string), ')']] as Prop.FontSize | Cust.Expr,
        fontSize6         : [['calc(', 1.00, '*', (gens.fontSize as string), ')']] as Prop.FontSize | Cust.Expr,
